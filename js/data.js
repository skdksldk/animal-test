...
const qnaList = [
    {
      q: '1. 연말인데, 날도 춥고 하니 집에 있고 싶다. 어떡하지?',
      a: [
        { answer: 'a.집에 있기 싫다. 되도록 사람 없는 곳으로 가서 연인과 즐겁게 놀고 싶다 ', type: [1, 2, 4, 9] },
        { answer: 'b. 집에서 시간을 보내면서 연인과 좋은 시간을 보낸다.', type: [0, 3, 6, 5, 10, 8] },
    ...
    {
      q: '12. 상대방을 설득시키려고 했는데 부득이하게 갈등을 일으켰다. 어떡하지?',
      a: [
        { answer: 'a. 자신의 의견을 자세히 말하면서 상대를 설득시킨다', type: [3, 6, 4, 9 ] },
        { answer: 'b. 자신의 잘못을 인정하고 상대를 진정시킨다.', type: [0, 2, 5, 10, 8] },
  ...
  const infoList = [
    {
      name: '연애 뭐 식은 죽 먹기죠, 연애 재능 만땅 <MUZI>',
      desc: '연애의 프로재능러인 당신! MUZI에 해당하는 당신은 연애의 모든 것들을 알고 있어, 쉽게 연애에 성공하는 스타일이랍니다. 주로 포부가 크고 성격이 낙천적인 성향을 가지고 있고, 논리적이면서 두뇌회전이 매우 빠르다고 할 수 있어요. 말재주 또한 좋아 사교성이 좋고 유쾌하지만 화려한 것을 좋아해 허영심을 부리거나 사치를 부리기 때문에 이 점들을 주의해야 돼요. 뛰어난 능력에 자만하는 경우도 종종 있기 때문에 겸손이 필요하답니다! '
    },
    {
      name: '난 너만 봐, 정직한 연애 스타일의 <CORN>',
      desc: '연애 유형의 진국인 당신! CORN에 해당하는 당신은 상대방만 바라보는 해바라기 연애 스타일이랍니다. 매사에 끈기가 있어 연애를 할 때 성실하고 진심을 다하는 성향을 가지고, 온화하며 따뜻한 마음을 가지고 있어요. 한 번 좋아하면 끝까지 좋아하는 의리파지만 자존심이 쌔 은근히 고집이 강하답니다. 또한 욱하는 성질이 있어 이런 부분들을 조심해야 하고, 질투심이 많아 사랑이 집착으로 바뀔 수 있어 주의해야 된답니다! '
    },
    {
      name: '야 사귀자, 사랑을 쟁취하는 <RYAN>',
      desc: '한 번 좋아하는 사람이 있으면 내 사람으로 만드는 당신! RYAN에 해당하는 당신은 썸부터 사랑까지 한 번에 직진하는 스타일이랍니다. 연애할 때 주로 이끄는 성향을 가지고 있고, 시원시원한 성격과 유쾌한 성격을 가지고 있어요. 대쪽같은 성격에다 실수를 용납하는 대인배지만 유혹에 약하고 허영때문에 들뜨는 성격이라 다른 이성의 접근에 주의해야 돼요. 또한 내가 한 말로 인해 상대방이 상처를 받을 수 있기 때문에, 항상 말 조심이 필요하답니다!'
    },
    {
      name: '이건 어때? 난 어때? 독특한 매력을 가진 <APEACH>',
    ...
    {
      name: '결혼은 언제쯤 할까 신혼여행은 어디로?, 이상적인 연애관의 소유자 <NEO>',
      desc: '상대방과의 미래를 꿈꾸는 당신! 현실적인 연애보다는, 미래에 대한 이상적인 연애관을 가지고 있어요. 매일매일 사랑하는 사람과 보낼 미래를 생각하기 때문에, 연애에 뛰어난 자질이 있답니다. 또한 일적으로나 사랑으로나 야망이 커, 크게 성공할 확률이 높고 리더십이 매우 뛰어나답니다. 다만 높은 이상에 비해서 현실이 자신의 마음에 들지 않으면 허세를 부리거나 사람들을 무시하는 경우가 많으니 이점들을 주의하면 좋을 것 같아요!'
    },
    {
      name: '기념일에 무슨 이벤트 할까, 이벤트 플래너 <IF>',
    ...
    {
      name: '어 오늘 머리 바꿨네 잘 어울린다, 센스가 뛰어난 <EVE>',
    ...
    {
      name: '난 너랑 하는 것들 다 좋아, 순종적인 <KAKAGO>',
    ...
    {
      name: '난 당신의 연예인, 끼가 넘치는 재주꾼 <TUBR>',
    ...
    {
      name: '이건 이거고 저건 저거지 , 공과사 확실한 <DOCTOR>',
    ...
    {
      name: '산은 산이요 연애는 연애로다, 느긋하고 온순한 <JAY-G>',
